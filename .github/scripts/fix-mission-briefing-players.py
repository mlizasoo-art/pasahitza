...
# Site-level learner navigation v2 is the final structural pass. Back arrows are
# deterministic parent links, never browser-history actions, so route loops are impossible.
